    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            for (let i = 0; i < data[0].postTags.length; i++) {
                msg += `
                <a class="inline-flex items-center gap-2 rounded-full bg-gray-100 px-3 py-1 text-sm font-medium text-gray-900 transition-colors hover:bg-gray-200 dark:bg-gray-800 dark:text-gray-200 dark:hover:bg-gray-700">
